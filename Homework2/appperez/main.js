...
d3.csv("fitness_data.csv").then(rawData =>{
    ...
    filteredData["columns"] = ["Did wearable motivate person to exercise?",  "Was the exercise more enjoyable?", "Exercise weekly frequency."]
    ...
    .nodeWidth(4)
    .nodePadding(10)
    .extent([[0, 5], [sankeyWidth + 100, sankeyHeight - 5]])
  ...
  colTitleData = (() => {
    ...
    for (const node of nodes) {
        ...
        data.push({x0: node["x0"], x1: node["x1"], columnName: node.columnName})
    }
